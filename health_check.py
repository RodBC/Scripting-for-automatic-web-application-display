#Checks CPU usage, available memory, disk space and hostname. 
#If any of the parameters reach critical level sends an email with Error message (different message for each error
